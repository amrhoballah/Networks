...
app.get('/readlist', async (req, res) => {
    let data
    try {
        data = await database.db("Users").collection("Users").findOne({
...
app.post('/register', async (req, res) => {
    ...
    let result
    try {
        result = await database.db("Users").collection("Users").findOne({
...
app.post('/addtoreadinglist', async (req, res) => {
    let data
    let currentUser = req.session.name
    try {
        data = await database.db("Users").collection("Users").findOne({
    ...
    try {
        await database.db("Users").collection("Users").updateOne({
            username: currentUser
        }, {
            $set: {
